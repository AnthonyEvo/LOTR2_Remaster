...
public class UIGameRenderer extends JPanel {
	...
	UIGameRenderer() {
		...
		System.out.println(
			polygon.getNormal().getBegin().getX() + " " + 
			polygon.getNormal().getBegin().getY() + " " + 
			polygon.getNormal().getBegin().getZ() 
		);
		
		System.out.println(
			polygon.getNormal().getEnd().getX() + " " + 
			polygon.getNormal().getEnd().getY() + " " + 
			polygon.getNormal().getEnd().getZ() 
		);
	}
